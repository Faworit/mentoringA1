...
public class CacheServiceLFU {
    ...
    private Map<Integer, CacheObject> cacheValue = new ConcurrentHashMap<>(CAPACITY);
    private Map<Integer, EvictionPolicy> cache = new ConcurrentHashMap<>(CAPACITY);
    ...
    public static synchronized CacheServiceLFU getInstance() {
    ...
    public Map<Integer, CacheObject> getCacheValue() {
        return cacheValue;
    }
}
